...
class StorageService {
  ...
  // method untuk membuat file baru ke dalam server (meta:informasi dari sebuah file, path:lokasi gambar)
...
// filestream untuk menuliskan file
    const fileStream = fs.createWriteStream(path);
// primise : janji bakal nulis file 
